/**
 * helper_functions.h
 * Helper functions for the 2D particle filter.
 *
 ...
 *
 * @param x variables
 * @param m means of the distribution
 * @param std standard deviations of the distribution
 * @return the probabilty of x for given multivariate normal distribution
 */
